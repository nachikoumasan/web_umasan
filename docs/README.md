...
| スライド | index.html と assets/js/app.js。Echo AgainとLINEスタンプは動画サムネイルを初期表示し、手動で切替。Echo Againの矢印は画像の中央左右。他のスライドは4.5秒の自動送り・操作中停止・動きを減らす設定に対応 |
...
| 紹介画像 | assets/css/journal.css。PC225px、850px以下180px、600px以下145px。過去記録の88pxは現行値ではない |
